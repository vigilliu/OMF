...
def patch_mask(img, mask_ratio):
    ...
    img[w:w+patch_pixel_x, h:h+patch_pixel_y, z:z+patch_pixel_z] = 0
...
def var_all_case_LA(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
    ...
    with open('/home/vigil/Desktop/OMF-main/data/byh_data/SSNet_data/LA/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = ["/home/vigil/Desktop/OMF-main/data/byh_data/SSNet_data/LA/2018LA_Seg_Training Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]
    ...
    for image_path in loader:
        ...
        #y = image
        #cv2.imwrite('/home/vigil/Desktop/image_test/%s.png'%image_path,y)
...
def test_all_case(model, image_list, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4, save_result=True, test_save_path=None, preproc_fn=None, metric_detail=0, nms=0):
    ...
    for image_path in loader:
        ...
        image = h5f['image'][:]
        #=============================================
        #image = patch_mask(image,0.01)
        #=============================================
        #print(image.shape)#(175, 132, 88)
        label = h5f['label'][:]
