...
#vigil====================================================================================
def vigil_loss(net_output, mixlab, paste_weight=1.0, background_weight=0.5):
    #net_output, mixlab = net_output(torch.int64), mixlab.type(torch.int64)
    loss_dice = DICE(net_output, mixlab)
    loss_ce = CE(net_output, mixlab.long())
